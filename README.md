...
*   **Cybersecurity:** Estudante de segurança ofensiva/defensiva, prática em **CTFs**, desenvolvimento de ferramentas de pentest, criptografia e malwares.

*   **Artificial Intelligence:** Desenvolvimento de modelos de Inteligência Artificial. Uso de arquiteturas de Deep Learning como Redes Neurais Artificiais, Transformers, Redes Neurais Convolucionais etc.

*   **Sistemas:** Domínio avançado de ecossistemas **Linux** e administração de redes básico.
